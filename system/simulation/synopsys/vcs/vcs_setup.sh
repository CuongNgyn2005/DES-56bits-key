...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/system_rsp_xbar_mux_001.sv \
  $QSYS_SIMDIR/submodules/system_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/system_rsp_xbar_demux_003.sv \
  $QSYS_SIMDIR/submodules/system_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/system_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/system_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/system_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/system_id_router_003.sv \
  $QSYS_SIMDIR/submodules/system_id_router.sv \
  $QSYS_SIMDIR/submodules/system_addr_router_001.sv \
  ...
  $QSYS_SIMDIR/submodules/DES_ALGORITHM.v \
  $QSYS_SIMDIR/submodules/DES_CONTROL.v \
  $QSYS_SIMDIR/submodules/E_MATRIX.v \
  $QSYS_SIMDIR/submodules/E_XOR_KEY.v \
  $QSYS_SIMDIR/submodules/F_FUNCTION.v \
  $QSYS_SIMDIR/submodules/IP.v \
  $QSYS_SIMDIR/submodules/IP_1.v \
  $QSYS_SIMDIR/submodules/MUX2_1_TOP.v \
  $QSYS_SIMDIR/submodules/P_MATRIX.v \
  $QSYS_SIMDIR/submodules/PC_1.v \
  $QSYS_SIMDIR/submodules/PC_2.v \
  $QSYS_SIMDIR/submodules/S_BOX.v \
  $QSYS_SIMDIR/submodules/SHIFT_LEFT_1.v \
  $QSYS_SIMDIR/submodules/SHIFT_LEFT_2.v \
  $QSYS_SIMDIR/submodules/DES_AVALON_WRAPPER.v \
