...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_xbar_mux_001                                                                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_rsp_xbar_demux_003.sv"                    -work rsp_xbar_demux_003                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_rsp_xbar_demux.sv"                        -work rsp_xbar_demux                                                                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_id_router_003.sv"                         -work id_router_003                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_id_router.sv"                             -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/system_addr_router.sv"                           -work addr_router                                                                      
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/DES_ALGORITHM.v"                                 -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/DES_CONTROL.v"                                   -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/E_MATRIX.v"                                      -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/E_XOR_KEY.v"                                     -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/F_FUNCTION.v"                                    -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/IP.v"                                            -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/IP_1.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/MUX2_1_TOP.v"                                    -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/P_MATRIX.v"                                      -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/PC_1.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/PC_2.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/S_BOX.v"                                         -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/SHIFT_LEFT_1.v"                                  -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/SHIFT_LEFT_2.v"                                  -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/DES_AVALON_WRAPPER.v"                            -work DES_0                                                                            
