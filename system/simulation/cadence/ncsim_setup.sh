...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                  -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                                 
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_rsp_xbar_demux_003.sv"                    -work rsp_xbar_demux_003                                                                -cdslib ./cds_libs/rsp_xbar_demux_003.cds.lib                                                               
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                                -cdslib ./cds_libs/cmd_xbar_demux_001.cds.lib                                                               
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_id_router_003.sv"                         -work id_router_003                                                                     -cdslib ./cds_libs/id_router_003.cds.lib                                                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_id_router.sv"                             -work id_router                                                                         -cdslib ./cds_libs/id_router.cds.lib                                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/system_addr_router_001.sv"                       -work addr_router_001                                                                   -cdslib ./cds_libs/addr_router_001.cds.lib                                                                  
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/DES_ALGORITHM.v"                                 -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/DES_CONTROL.v"                                   -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/E_MATRIX.v"                                      -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/E_XOR_KEY.v"                                     -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/F_FUNCTION.v"                                    -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/IP.v"                                            -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/IP_1.v"                                          -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/MUX2_1_TOP.v"                                    -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/P_MATRIX.v"                                      -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/PC_1.v"                                          -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/PC_2.v"                                          -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/S_BOX.v"                                         -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/SHIFT_LEFT_1.v"                                  -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/SHIFT_LEFT_2.v"                                  -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/DES_AVALON_WRAPPER.v"                            -work DES_0                                                                             -cdslib ./cds_libs/DES_0.cds.lib                                                                            
