...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                     -work rsp_xbar_mux_001                                                                 
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_rsp_xbar_demux_003.sv"                    -work rsp_xbar_demux_003                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_id_router_003.sv"                         -work id_router_003                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_id_router.sv"                             -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/system_tb/simulation/submodules/system_addr_router_001.sv"                       -work addr_router_001                                                                  
  ...
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/DES_ALGORITHM.v"                                 -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/DES_CONTROL.v"                                   -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/E_MATRIX.v"                                      -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/E_XOR_KEY.v"                                     -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/F_FUNCTION.v"                                    -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/IP.v"                                            -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/IP_1.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/MUX2_1_TOP.v"                                    -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/P_MATRIX.v"                                      -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/PC_1.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/PC_2.v"                                          -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/S_BOX.v"                                         -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/SHIFT_LEFT_1.v"                                  -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/SHIFT_LEFT_2.v"                                  -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/DES_AVALON_WRAPPER.v"                            -work DES_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/system_jtag_uart_0.v"                            -work jtag_uart_0                                                                      
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/system_onchip_memory2_0.v"                       -work onchip_memory2_0                                                                 
